...
urlpatterns = [
    ...
    path('acercade/', views.editar_acerca_de, name='editar_acerca_de'),
    path('api/acercade/', views.obtener_acercade_json, name='api_acercade'),
    path('statement/', views.ver_statement, name='ver_statement'),
    path('statement/editar/', views.editar_statement, name='editar_statement'),
